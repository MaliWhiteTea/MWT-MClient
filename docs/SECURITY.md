...
- Linux/Raspberry Pi adaptörü root olmayan servis UID'si sahipliğinde dizin için tam `0700`, korumalı dosya için tam `0600` ister; UID `0`'ı, grup/diğer erişimini, sembolik bağı ve beklenmeyen dosya türünü reddeder. Windows DACL'sinin çalışma zamanında güvenilir okunması O-109 çözülene kadar Windows servis entegrasyonu tamamlanmış sayılmaz.
