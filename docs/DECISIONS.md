...
### O-109 — Yönetici oturum politikası

Idle/absolute oturum süreleri, parola minimumları ve hangi işlemlerde yeniden doğrulama isteneceği güvenlik ile yerel kullanım kolaylığı arasında ürün tercihi gerektirir. Öneri scrypt tabanlı parola doğrulayıcı, en az 12 karakter, 30 dakika idle ve 24 saat absolute oturumdur; ürün sahibi onayı beklenir.
