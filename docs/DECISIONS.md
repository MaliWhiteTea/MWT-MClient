...
| D-051  | Yönetici parola doğrulaması kaynak anahtarı başına dakikada en çok beş deneme ve süreç genelinde aynı anda bir scrypt işiyle sınırlıdır; dolu işlem yeni pahalı işi kuyruğa almaz. Oturum kabulü audience, iptal ve iki süre sınırını tek atomik repository işleminde doğrular ve idle süresini aynı işlemde yeniler. | Kabul edildi |
