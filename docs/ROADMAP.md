...
- Yalnız açık loopback adresine bağlanan HTTP çalışma zamanı, korumalı bootstrap kanıt sağlayıcısı, kontrollü kapanış, tek yönetici ve ayrı LAN HTTPS durum makinesi
...
- Windows ACL yardımcı programının .NET 10 LTS/`win-x64` sabit build profili ve sürümlü protokole göre üretilmesi, paket bütünlüğü ve gerçek servis hesabı altında entegrasyon testi
